<div class="page page-center">
  <div class="container container-tight py-4">
      ...
      <div class="card-body">
        ...
        <?= $this->Form->create(null, ['autocomplete' => 'off', 'novalidate' => true]) ?>
          <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control" placeholder="<?= __('Enter email') ?>" required autofocus>
          </div>
          <div class="form-footer">
            <button type="submit" class="btn btn-primary w-100">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-1"><path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10z"></path><path d="M3 7l9 6l9 -6"></path></svg>
    ...
    <div class="text-center text-secondary mt-3">
      <?= __('Forget it,') ?> <?= $this->Html->link(__('send me back'), ['prefix' => 'Admin', 'controller' => 'Users', 'action' => 'login']) ?> <?= __('to the sign in screen.') ?>
    </div>
  </div>
</div>