<div class="page page-center">
  <div class="container container-tight py-4">
    ...
    <div class="card card-md shadow">
      <div class="card-body">
        <h2 class="card-title text-center mb-4"><?= __('Set new password') ?></h2>
        ...
        <?= $this->Form->create(null, ['autocomplete' => 'off', 'novalidate' => true]) ?>
          <div class="mb-3">
            ...
            <div class="input-group input-group-flat">
              <input type="password" name="password" id="reset-password" class="form-control" placeholder="<?= __('New password') ?>" autocomplete="new-password" required autofocus>
              <span class="input-group-text">
                <a href="#" id="toggle-reset-pwd-btn" class="link-secondary" title="<?= __('Show password') ?>" data-bs-toggle="tooltip">
          ...
          <div class="mb-3">
            ...
            <input type="password" name="password_confirm" class="form-control" placeholder="<?= __('Confirm new password') ?>" autocomplete="new-password" required>
          </div>
    ...
    <div class="text-center text-secondary mt-3">
      <?= $this->Html->link(__('Back to Sign in'), ['prefix' => 'Admin', 'controller' => 'Users', 'action' => 'login']) ?>
    </div>
  </div>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
    const toggleBtn = document.getElementById('toggle-reset-pwd-btn');
