  ...
  <div class="container container-tight py-4">
    ...
    <div class="card card-md shadow-lg">
      <div class="card-body">
        ...
        <?= $this->Form->create(null, ['autocomplete' => 'off', 'novalidate' => true]) ?>
          <div class="mb-3">
            <label class="form-label"><?= __('Email address') ?></label>
            <input type="email" name="email" class="form-control" placeholder="<?= __('your@email.com') ?>" autocomplete="off" required autofocus>
          </div>
          <div class="mb-2">
            <label class="form-label">
              <?= __('Password') ?>
              <span class="form-label-description">
                <?= $this->Html->link(__('I forgot password'), ['prefix' => 'Admin', 'controller' => 'Users', 'action' => 'forgotPassword']) ?>
              </span>
            </label>
            <div class="input-group input-group-flat">
              <input type="password" name="password" id="login-password" class="form-control" placeholder="<?= __('Your password') ?>" autocomplete="off" required>
		...
		<div class="card-body">
		  <div class="row">
			<!-- Facebook színes natív ikonnal -->
			<div class="col">
			  <?= $this->Html->link(
				  '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="icon me-2">
				  ...
				  ['escape' => false, 'class' => 'btn w-100 align-items-center justify-content-center']
			  ) ?>
			</div>

			<!-- Google / Gmail színes 4-színű natív ikonnal -->
			<div class="col">
			  <?= $this->Html->link(
				  '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="icon me-2">
    ...
    <div class="text-center text-secondary mt-3">
      <?= __('Don\'t have account yet?') ?> <?= $this->Html->link(__('Sign up'), ['prefix' => 'Admin', 'controller' => 'Users', 'action' => 'register'], ['tabindex' => '-1']) ?>
    </div>
  </div>
</div>
