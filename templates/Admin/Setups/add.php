 ...
 */
?>
<div class="page-header d-print-none mb-3 setups">
    <div class="row align-items-center">
        <div class="col">
            <h2 class="page-title"><?= __('Új {0} felvitele', __('Setup')) ?></h2>
        </div>
...
<div class="card setups">
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <?= $this->Html->link(__('Value'), '#tabs-value', ['class' => 'nav-link', 'data-bs-toggle' => 'tab', 'aria-selected' => 'false', 'role' => 'tab', 'tabindex' => '-1']) ?>
            </li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tabs-datesheet" role="tabpanel">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('type', ['label' => ['text' => __('Type'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('edit_by', ['label' => ['text' => __('Edit By'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>

                </div>
            </div> <!-- /#tabs-datesheet -->

            <!-- 2. További adatok fül: value -->
