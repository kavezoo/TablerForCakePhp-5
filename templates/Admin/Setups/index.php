...
$lastViewedId = $lastViewedId ?? $this->getRequest()->getSession()->read('LastViewed.setup_id');
$scrollToId = $scrollToId ?? $this->getRequest()->getSession()->read('ScrollTo.setup_id') ?? $lastViewedId;
...
<?php endif; ?>
            ...
            <tbody>
                ...
                <tr id="row-<?= (int)$setup->id ?>" class="<?= $isLastViewed ? 'last-viewed' : '' ?>">
<?php if (isset($showId) && $showId): ?>
