...
<div class="page-header d-print-none mb-3 emailTemplates">
    <div class="row align-items-center">
        <div class="col">
            <h2 class="page-title"><?= __('Új {0} felvitele', __('Email Template')) ?></h2>
        </div>
...
<div class="card emailTemplates">
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <?= $this->Html->link(__('Body Html'), '#tabs-body_html', ['class' => 'nav-link', 'data-bs-toggle' => 'tab', 'aria-selected' => 'false', 'role' => 'tab', 'tabindex' => '-1']) ?>
            </li>
            <li class="nav-item" role="presentation">
                <?= $this->Html->link(__('Body Text'), '#tabs-body_text', ['class' => 'nav-link', 'data-bs-toggle' => 'tab', 'aria-selected' => 'false', 'role' => 'tab', 'tabindex' => '-1']) ?>
            </li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tabs-datesheet" role="tabpanel">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('subject', ['label' => ['text' => __('Subject'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
            ...
            <!-- 2. További adatok fül: body_html -->
            ...
            <!-- 2. További adatok fül: body_text -->
            <div class="tab-pane fade" id="tabs-body_text" role="tabpanel">
                <div class="row g-3">
                    <div class="col-12">
                        <?= $this->Form->control('body_text', [
                            'type' => 'textarea',
                            'id' => 'hugerte-body_text',
                            'label' => false,
                            'class' => 'form-control hugerte-editor',
                            'rows' => 14,
                        ]) ?>
