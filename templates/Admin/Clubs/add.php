...
<div class="page-header d-print-none mb-3 clubs">
    <div class="row align-items-center">
        <div class="col">
            <h2 class="page-title"><?= __('Új {0} felvitele', __('Club')) ?></h2>
        </div>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tabs-datesheet" role="tabpanel">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('clubpresident_id', ['label' => ['text' => __('Clubpresident Id'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('name', ['label' => ['text' => __('Name'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('short_name', ['label' => ['text' => __('Short Name'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('address', ['label' => ['text' => __('Address'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('phone', ['label' => ['text' => __('Phone'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('web', ['label' => ['text' => __('Web'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('facebook', ['label' => ['text' => __('Facebook'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('insta', ['label' => ['text' => __('Insta'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('competition_count', [
                            'label' => ['text' => __('Competition Count')],
                            'min' => 0,
                            'max' => 4294967295,
                            'step' => '1',
                            'value' => '0'
