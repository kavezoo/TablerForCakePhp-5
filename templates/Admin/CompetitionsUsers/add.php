 ...
 * @var \Cake\Collection\CollectionInterface|string[] $competitions
 * @var \Cake\Collection\CollectionInterface|string[] $subclubs
 */
?>
<div class="page-header d-print-none mb-3 competitionsUsers">
    <div class="row align-items-center">
        <div class="col">
            <h2 class="page-title"><?= __('Új {0} felvitele', __('Competitions User')) ?></h2>
        </div>
...
<div class="card competitionsUsers">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tabs-datesheet" role="tabpanel">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('subclub_id', [
                            'options' => $subclubs,
                            'label' => ['text' => __('Subclub Id'), 'class' => 'form-label'],
                            'class' => 'form-select tom-select',
                            'empty' => true
                        ]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('status', ['label' => ['text' => __('Status'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('companion_count', [
                            'label' => ['text' => __('Companion Count')],
                            'min' => -2147483648,
                            'max' => 2147483647,
                            'step' => '1',
                            'value' => '0'
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('special_lunch', ['label' => ['text' => __('Special Lunch'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('racing_pipe_1_qty', [
                            'label' => ['text' => __('Racing Pipe 1 Qty')],
                            'min' => 0,
                            'max' => 4294967295,
                            'step' => '1',
                            'value' => ''
                    ...
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('racing_pipe_2_qty', [
                            'label' => ['text' => __('Racing Pipe 2 Qty')],
                            'min' => 0,
                            'max' => 4294967295,
                            'step' => '1',
                            'value' => ''
                    ...
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('racing_pipe_3_qty', [
                            'label' => ['text' => __('Racing Pipe 3 Qty')],
                            'min' => 0,
                            'max' => 4294967295,
                            'step' => '1',
                            'value' => ''
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('comment', ['label' => ['text' => __('Comment'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>
                    <div class="col-md-4">
                        <?= $this->KvForm->dateTimePicker('fee_paid_at', ['label' => ['text' => __('Fee Paid At')]]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('fee_paid_by', ['label' => ['text' => __('Fee Paid By'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('entry_fee_amount', [
                            'label' => ['text' => __('Entry Fee Amount')],
                            'precision' => 2,
                            'step' => '0.01',
                            'value' => '0.00'
                        ]) ?>
                    ...
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('racing_pipe_1_fee', [
                            'label' => ['text' => __('Racing Pipe 1 Fee')],
                            'precision' => 2,
                            'step' => '0.01',
                            'value' => '0.00'
                        ]) ?>
                    ...
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('racing_pipe_2_fee', [
                            'label' => ['text' => __('Racing Pipe 2 Fee')],
                            'precision' => 2,
                            'step' => '0.01',
                            'value' => '0.00'
                        ]) ?>
                    ...
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('racing_pipe_3_fee', [
                            'label' => ['text' => __('Racing Pipe 3 Fee')],
                            'precision' => 2,
                            'step' => '0.01',
                            'value' => '0.00'
                        ]) ?>
                    ...
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('lunch_fee', [
                            'label' => ['text' => __('Lunch Fee')],
                            'precision' => 2,
                            'step' => '0.01',
                            'value' => '0.00'
                        ]) ?>
                    ...
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('fee_total', [
                            'label' => ['text' => __('Fee Total')],
                            'precision' => 2,
                            'step' => '0.01',
                            'value' => '0.00'
                        ]) ?>
                    ...
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('result_time', [
                            'label' => ['text' => __('Result Time')],
                            'precision' => 3,
                            'step' => '0.001',
                            'value' => ''
                        ]) ?>
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('result_recorded_by_email', ['label' => ['text' => __('Result Recorded By Email'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->KvForm->numberSpinner('result_rank', [
                            'label' => ['text' => __('Result Rank')],
                            'min' => 0,
                            'max' => 4294967295,
                            'step' => '1',
                            'value' => ''
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('result_score', ['label' => ['text' => __('Result Score'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('result_note', ['label' => ['text' => __('Result Note'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>
