...
<div class="page-header d-print-none mb-3 cities">
    <div class="row align-items-center">
        <div class="col">
            <h2 class="page-title"><?= __('Új {0} felvitele', __('City')) ?></h2>
        </div>
    ...
    <div class="card-body pb-4">
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tabs-datesheet" role="tabpanel">
                <div class="row g-3">
                    <div class="col-md-6">
                        <?= $this->Form->control('shortname', ['label' => ['text' => __('Shortname'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('lat', ['label' => ['text' => __('Lat'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('lng', ['label' => ['text' => __('Lng'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
