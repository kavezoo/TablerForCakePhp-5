...
<div class="page-header d-print-none mb-3 socialAccounts">
    <div class="row align-items-center">
        <div class="col">
            <h2 class="page-title"><?= __('Új {0} felvitele', __('Social Account')) ?></h2>
        </div>
...
<div class="card socialAccounts">
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <?= $this->Html->link(__('Avatar'), '#tabs-avatar', ['class' => 'nav-link', 'data-bs-toggle' => 'tab', 'aria-selected' => 'false', 'role' => 'tab', 'tabindex' => '-1']) ?>
            </li>
            <li class="nav-item" role="presentation">
                <?= $this->Html->link(__('Description'), '#tabs-description', ['class' => 'nav-link', 'data-bs-toggle' => 'tab', 'aria-selected' => 'false', 'role' => 'tab', 'tabindex' => '-1']) ?>
            </li>
            <li class="nav-item" role="presentation">
                <?= $this->Html->link(__('Data'), '#tabs-data', ['class' => 'nav-link', 'data-bs-toggle' => 'tab', 'aria-selected' => 'false', 'role' => 'tab', 'tabindex' => '-1']) ?>
            </li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tabs-datesheet" role="tabpanel">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('provider', ['label' => ['text' => __('Provider'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('username', ['label' => ['text' => __('Username'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('reference', ['label' => ['text' => __('Reference'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('link', ['label' => ['text' => __('Link'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('token', ['label' => ['text' => __('Token'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('token_secret', ['label' => ['text' => __('Token Secret'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>
                    <div class="col-md-4">
            ...
            <!-- 2. További adatok fül: avatar -->
            <div class="tab-pane fade" id="tabs-avatar" role="tabpanel">
                <div class="row g-3">
                    <div class="col-12">
            ...
            <!-- 2. További adatok fül: data -->
            <div class="tab-pane fade" id="tabs-data" role="tabpanel">
                <div class="row g-3">
                    <div class="col-12">
