 ...
 * @property \App\Model\Table\CompetitionsTable&\Cake\ORM\Association\BelongsToMany $Competitions
 *
...
class UsersTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->notEmptyString('membership_status');

        $validator
            ->date('membership_joined_date')
            ->allowEmptyDate('membership_joined_date');
        ...
        $validator
            ...
            ->notEmptyString('application_notified');
